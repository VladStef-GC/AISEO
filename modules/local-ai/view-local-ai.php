        ...
        <div class="local-ai-card">
            ...
            <table class="form-table" role="presentation">
                ...
                <tr>
                    ...
                    <td>
                        <input type="number" id="local-ai-timeout" name="local_timeout" class="small-text" value="<?php echo esc_attr($saved_timeout); ?>" min="10" max="600"> seconds
                        <p class="description">Local models can be slower than cloud. Increase if you get timeout errors.</p>
                    </td>
                </tr>
            </table>
