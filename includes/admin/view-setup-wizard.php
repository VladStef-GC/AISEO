...
<div class="wrap aisc-wizard">
    ...
    <div id="aisc-step-2" class="aisc-step<?php echo ! $has_index ? ' locked' : ''; ?>">
        ...
        echo \AI_SEO_Captain\Admin::render_banner(
            'is-live',
            esc_html__('Frontend Output', 'ai-seo-captain'),
            sprintf(
                /* translators: %s: link to Frontend Output setting */
                esc_html__('Check your %s setting to control whether generated metadata is visible to search engines and visitors.', 'ai-seo-captain'),
                '<a href="' . esc_url(admin_url('admin.php?page=ai-seo-captain-settings#ai-seo-frontend-output')) . '" target="_blank">' . esc_html__('Frontend Output', 'ai-seo-captain') . '</a>'
            )
