        ...
        <table class="widefat striped ai-seo-sortable" id="ai-seo-image-table">
            <thead>
                <tr>
                    ...
                    <th style="width:25%;" class="ai-seo-sort" data-col="1">File <span class="ai-seo-sort-icon dashicons dashicons-sort"></span></th>
                    <th style="width:40%;" class="ai-seo-sort" data-col="2">Alt text <span class="ai-seo-sort-icon dashicons dashicons-sort"></span></th>
                    <th style="width:20%;" class="ai-seo-sort" data-col="3">Used on <span class="ai-seo-sort-icon dashicons dashicons-sort"></span></th>
                    <th style="width:5%;"></th>
                </tr>
            </thead>
            <tbody>
